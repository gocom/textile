...
$parser = new Netcarver\Textile\Parser();                 // Create a textile parser
...
bc.. include "Netcarver/Textile/Parser.php";
include "Netcarver/Textile/Databag.php";
include "Netcarver/Textile/Tag.php";
...
bc.. $parser = new \Netcarver\Textile\Parser('html5'); // adjust if you need a different doctype
$out = $parser
...
bc.. $parser = new \Netcarver\Textile\Parser('html5'); // target whatever doctype you need
$out = $parser
